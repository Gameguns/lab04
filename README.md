[![CI Linux](https://github.com/Gameguns/lab04/actions/workflows/linux.yml/badge.svg)](https://github.com/Gameguns/lab04/actions/workflows/linux.yml)
# Laboratory Work №4
...
- Зафиксировать все выполненные команды в файле `output.txt`.
- Оформить отчет и отправить ссылку на репозиторий в Telegram.
...
```bash
export GITHUB_USERNAME=Gameguns
...
Для документирования всех выполненных действий я использовал утилиту script, которая сохранила ввод и вывод терминала в файл output.txt . Этот файл также размещён в репозитории.
